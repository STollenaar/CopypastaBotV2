module github.com/stollenaar/copypastabotv2/internal/commands/markov
...
require (
	...
	github.com/stollenaar/copypastabotv2/pkg/markov v0.0.0-20241230025036-7d9f4114e28a
)
